! function(e, t) {
    ...
    return function() {
        ...
        var Pe = je(),
            De = je({
                defaultModifiers: [oe, Oe, ie, D, Ae, be, Te, Z, Ee]
            }),
            Ie = je({
                                    ...
                                    try {
                                        for (c.s(); !(s = c.n()).done;)
                                            if (s.value === a) return Wt(r, {
                                                delegateTarget: a
                                            }), i.oneOff && Ht.off(e, r.type, t, n), n.apply(a, [r])
                                    } catch (e) {
                                        c.e(e)
                                    } finally {
                                        c.f()
                ...
                return Be(t, e), Xe(t, [{
                    ...
                    value: function(e) {
                        var t = this,
                            n = this._getItems();
                        if (!(e > n.length - 1 || e < 0))
                            if (this._isSliding) Ht.one(this._element, wn, (function() {
                                return t.to(e)
                            }));
                            else {
        ...
        var Ei = "backdrop",
            ...
            ir = function(e) {
                ...
                return Be(t, e), Xe(t, [{
                    ...
                    value: function(e) {
                        var t = this;
                        this._isShown || this._isTransitioning || (Ht.trigger(this._element, Ki, {
                            relatedTarget: e
                        }).defaultPrevented || (this._isShown = !0, this._isTransitioning = !0, this._scrollBar.hide(), document.body.classList.add(Ji), this._adjustDialog(), this._backdrop.show((function() {
                    ...
                    value: function(e) {
                        ...
                        this._queueCallback((function() {
                            t._config.focus && t._focustrap.activate(), t._isTransitioning = !1, Ht.trigger(t._element, Qi, {
                                relatedTarget: e
                            })
        ...
        var rr = ".".concat("bs.offcanvas"),
            ...
            kr = function(e) {
                ...
                return Be(t, e), Xe(t, [{
                    ...
                    value: function(e) {
                        var t = this;
                        if (!this._isShown && !Ht.trigger(this._element, fr, {
                                relatedTarget: e
                            }).defaultPrevented) {
                            ...
                            this._queueCallback((function() {
                                t._config.scroll && !t._config.backdrop || t._focustrap.activate(), t._element.classList.add(sr), t._element.classList.remove(cr), Ht.trigger(t._element, dr, {
                                    relatedTarget: e
                                })
                            }), this._element, !0)
                        }
        ...
        var Vr = ".".concat("bs.scrollspy"),
            ...
            eo = function(e) {
                ...
                return Be(t, e), Xe(t, [{
                    ...
                    key: "_process",
                    value: function(e) {
                        this._activeTarget !== e && (this._clearActiveClass(this._config.target), this._activeTarget = e, e.classList.add(Xr), this._activateParents(e), Ht.trigger(this._element, Kr, {
                            relatedTarget: e
                        }))
                    }
                }, {
                    ...
                    value: function(e) {
                        if (e.classList.contains("dropdown-item")) Yt.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(Xr);
                        else {
                ...
                return Be(t, e), Xe(t, [{
                    ...
                    value: function(e, t) {
                        ...
                        if (e) {
                            ...
                            this._queueCallback((function() {
                                "tab" === e.getAttribute("role") ? (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), n._toggleDropDown(e, !0), Ht.trigger(e, oo, {
                                    relatedTarget: t
                                })) : e.classList.add(_o)
                    ...
                    value: function(e, t) {
                        ...
                        if (e) {
                            ...
                            this._queueCallback((function() {
                                "tab" === e.getAttribute("role") ? (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), n._toggleDropDown(e, !1), Ht.trigger(e, io, {
                                    relatedTarget: t
