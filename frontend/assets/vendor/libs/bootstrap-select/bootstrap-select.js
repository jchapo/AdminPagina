                ...
                1936: function() {
                    ! function(e) {
                        ...
                        function r(t, s) {
                            ...
                            if (-1 !== e.inArray(l, s)) return -1 === e.inArray(l, i) || Boolean(t.nodeValue.match(n) || t.nodeValue.match(o));
                        ...
                        p = null, Object.values = "function" == typeof Object.values ? Object.values : function(e) {
                            return Object.keys(e).map((function(t) {
                                return e[t]
                            }))
                        }, String.prototype.startsWith || (d = {}.toString, h = function(e) {
                        ...
                        function I(e, t, i, s) {
                            for (var n = ["display", "subtext", "tokens"], o = !1, l = 0; l < n.length; l++) {
                                var r = n[l],
                                    a = e[r];
                                if (a && (a = a.toString(), "display" === r && (a = a.replace(/<[^>]+>/g, "")), s && (a = C(a)), a = a.toUpperCase(), o = "function" == typeof i ? i(a, t) : "contains" === i ? a.indexOf(t) >= 0 : a.startsWith(t))) break
                            }
                            return o
                        }
                        ...
                        try {
                            V.full = (U() || "").split(" ")[0].split("."), V.major = V.full[0], V.success = !0
                        } catch (e) {}
                        var _ = 0,
                            F = ".bs.select",
                            G = {
                            ...
                            var a = this.each((function() {
                                ...
                                if (i.is("select")) {
                                    ...
                                    if (r.title && (r.placeholder = r.title), l) {
                                        if (r)
                                            for (var a in r) Object.prototype.hasOwnProperty.call(r, a) && (l.options[a] = r[a])
                                    } else {
                                        var d = i.data();
                                        ...
                                        p.template = e.extend({}, te.DEFAULTS.template, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.template : {}, d.template, r.template), p.source = e.extend({}, te.DEFAULTS.source, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.source : {}, r.source), i.data("selectpicker", l = new te(this, p))
                                    }
                        ...
                        te.VERSION = "1.14.0-beta3", te.DEFAULTS = {
                            ...
                            createView: function(t, i, s) {
                                ...
                                function h(e, i) {
                                    var s, o, l, r, c, d, p, u, f, m, v = n.selectpicker.current.data.length,
                                        g = [],
                                        b = !0,
                                        w = n.isVirtual();
                                    ...
                                    if (void 0 === c && (c = 0), d = [n.selectpicker.view.position0, n.selectpicker.view.position1], l = Math.max(0, c - 1), r = Math.min(o - 1, c + 1), n.selectpicker.view.position0 = !1 === w ? 0 : Math.max(0, g[l][0]) || 0, n.selectpicker.view.position1 = !1 === w ? v : Math.min(v, g[r][1]) || 0, p = d[0] !== n.selectpicker.view.position0 || d[1] !== n.selectpicker.view.position1, void 0 !== n.activeElement && (i && (n.activeElement !== n.selectedElement && n.defocusItem(n.activeElement), n.activeElement = void 0), n.activeElement !== n.selectedElement && n.defocusItem(n.selectedElement)), void 0 !== n.prevActiveElement && n.prevActiveElement !== n.activeElement && n.prevActiveElement !== n.selectedElement && n.defocusItem(n.prevActiveElement), i || p || n.selectpicker.current.hasMore) {
                            ...
                            fetchData: function(e, t, i, s) {
                                ...
                                l ? (this.options.virtualScroll = !0, "function" == typeof l ? l.call(this, (function(i, s, l) {
                                    ...
                                    r.hasMore = s, r.totalItems = l, n = o.buildData(i, t), e.call(o, n), o.$element.trigger("fetched" + F)
                            ...
                            render: function(e) {
                                ...
                                if (this.options.source.data && e && (l.map((function e(t) {
                                    ...
                                    })), n.appendChild(this.selectpicker.main.optionQueue), o && (o = 0 === n.selectedIndex)), d.classList.toggle("bs-placeholder", s.multiple ? !r : !c && 0 !== c), s.multiple || 1 !== l.length || (s.selectpicker.view.displayedValue = c), "static" === this.options.selectedTextFormat) u = Z.text.call(this, {
                                    text: this.options.placeholder
                                }, !0);
                                else if ((t = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && r > 0) && (t = (i = this.options.selectedTextFormat.split(">")).length > 1 && r > i[1] || 1 === i.length && r >= 2), !1 === t) {
                                    if (!o) {
                            ...
                            selectPosition: function() {
                                ...
                                var t, i, s, n = this,
                                    ...
                                    l = function(l) {
                                        ...
                                        n.$bsContainer.addClass(l.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(G.DROPUP, l.hasClass(G.DROPUP)), t = l.offset(), o.is("body") ? i = {
                                            top: 0,
                                            left: 0
                                        } : ((i = o.offset()).top += parseInt(o.css("borderTopWidth")) - o.scrollTop(), i.left += parseInt(o.css("borderLeftWidth")) - o.scrollLeft()), s = l.hasClass(G.DROPUP) ? 0 : l[0].offsetHeight, (V.major < 4 || "static" === a) && (r.top = t.top - i.top + s, r.left = t.left - i.left), r.width = l[0].offsetWidth, n.$bsContainer.css(r)
                                    };
                                this.$button.on("click.bs.dropdown.data-api", (function() {
                                    n.isDisabled() || (l(n.$newElement), n.$bsContainer.appendTo(n.options.container).toggleClass(G.SHOW, !n.$button.hasClass(G.SHOW)).append(n.$menu))
                            ...
                            clickListener: function() {
                                ...
                                i.data("spaceSelect", !1), this.$button.on("keyup", (function(e) {
                                    ...
                                    if (t.options.allowClear) {
                                        var i = e.target,
                                            s = t.$clearButton[0];
                                        /MSIE|Trident/.test(window.navigator.userAgent) && (i = document.elementFromPoint(e.clientX, e.clientY)), i !== s && i.parentElement !== s || (e.stopImmediatePropagation(), function() {
                                            if (t.multiple) t.deselectAll();
                                                ...
                                                var e = t.$element[0],
                                                    ...
                                                    s = e.selectedIndex,
                                                    n = e.options[s],
                                                    o = !!n && t.selectpicker.main.data[n.liIndex];
                                                o && t.setSelected(o, !1), e.selectedIndex = 0, w = [s, !1, i], t.$element.triggerNative("change")
                                            }
                                    ...
                                    if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(), i.preventDefault(), !t.isDisabled() && !n.parent().hasClass(G.DISABLED)) {
                                        ...
                                        if (a === t.activeElement && (s = !0), s || (t.prevActiveElement = t.activeElement, t.activeElement = void 0), t.multiple && 1 !== E) {
                                            if (t.setSelected(r, !b), t.focusedParent.focus(), !1 !== E || !1 !== $) {
                                                ...
                                                if (E && S || $ && A)
                                                    ...
                                                    D[2] && (L = L.replace("{var}", D[2][E > 1 ? 0 : 1]), N = N.replace("{var}", D[2][$ > 1 ? 0 : 1])), t.$menu.append(H), E && S && (H.append(e("<div>" + L + "</div>")), u = !1, t.$element.trigger("maxReached" + F)), $ && A && (H.append(e("<div>" + N + "</div>")), u = !1, t.$element.trigger("maxReachedGrp" + F)), setTimeout((function() {
                                                        t.setSelected(r, !1)
                                ...
                                this.$button.on("click.bs.dropdown.data-api", (function() {
                                    ...
                                    if (e.selectpicker.search.elements = [], e.selectpicker.search.data = [], t)
                                        if (e.selectpicker.search.previousValue = t, e.options.source.search) e.fetchData((function(i) {
                                            e.render(), e.buildList(void 0, !0), e.noScroll = !0, e.$menuInner.scrollTop(0), e.createView(!0), X.call(e, i, t)
                                        }), "search", 0, t);
                                        else {
                                            var i = [],
                                                s = t.toUpperCase(),
                                            ...
                                            for (var a = 0; a < e.selectpicker.main.data.length; a++) {
                                                ...
                                                n[a] || (n[a] = I(c, s, l, r)), n[a] && void 0 !== c.headerIndex && -1 === o.indexOf(c.headerIndex) && (c.headerIndex > 0 && (n[c.headerIndex - 1] = !0, o.push(c.headerIndex - 1)), n[c.headerIndex] = !0, o.push(c.headerIndex), n[c.lastIndex + 1] = !0), n[a] && "optgroup-label" !== c.type && o.push(a)
                                            }
                                            a = 0;
                                            ...
                                            e.activeElement = void 0, e.noScroll = !0, e.$menuInner.scrollTop(0), e.selectpicker.search.elements = i, e.createView(!0), X.call(e, i, t)
                                        }
                            ...
                            keydown: function(t) {
                                ...
                                if (!(t.which >= 112 && t.which <= 123))
                                    if (!(s = c.$menu.hasClass(G.SHOW)) && (u || t.which >= 48 && t.which <= 57 || t.which >= 96 && t.which <= 105 || t.which >= 65 && t.which <= 90) && (c.$button.trigger("click.bs.dropdown.data-api"), c.options.liveSearch)) c.$searchbox.trigger("focus");
                                        ...
                                        s && (t.which === P && !c.selectpicker.keydown.keyHistory || t.which === M || t.which === W && c.options.selectOnTab) && (t.which !== P && t.preventDefault(), c.options.liveSearch && t.which === P || (c.$menuInner.find(".active a").trigger("click", !0), r.trigger("focus"), c.options.liveSearch || (t.preventDefault(), e(document).data("spaceSelect", !0))))
                                    }
                            },
                            mobile: function() {
