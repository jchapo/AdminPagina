    ...
    return function() {
        ...
        function s(t) {
            return function(t) {
                ...
                if (t) {
                    ...
                    return "Object" === i && t.constructor && (i = t.constructor.name), "Map" === i || "Set" === i ? Array.from(i) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? n(t, e) : void 0
                }
            }(t) || function() {
        ...
        var a = {
                ...
                log: function() {
                    ...
                    var n;
                    this.isEnabled() && (n = console).log.apply(n, ["[Tagify]:"].concat(s(e)))
                },
                warn: function() {
                    for (var t = arguments.length, e = new Array(t), i = 0; i < t; i++) e[i] = arguments[i];
                    var n;
                    this.isEnabled() && (n = console).warn.apply(n, ["[Tagify]:"].concat(s(e)))
                }
            },
            o = function(t, e, i, n) {
            ...
            function a(t, e) {
                for (var i in e)
                    if (e.hasOwnProperty(i)) {
                        if (g(e[i])) {
                            g(t[i]) ? a(t[i], e[i]) : t[i] = Object.assign({}, e[i]);
                            continue
                        }
                ...
                for (var a, o = arguments[Symbol.iterator](); !(i = (a = o.next()).done); i = !0) {
                    ...
                    try {
                        for (var u, h = r[Symbol.iterator](); !(l = (u = h.next()).done); l = !0) {
                            var p = u.value;
                            g(p) ? e[p.value] || (t.push(p), e[p.value] = 1) : t.includes(p) || t.push(p)
                        }
                    } catch (t) {
                        d = !0, c = t
                    } finally {
        ...
        function b(t) {
            var e;
            return w.call(this, t) && (null == t || null === (e = t.classList) || void 0 === e ? void 0 : e.contains(this.settings.classNames.tag))
        }

        function y(t) {
            return w.call(this, t) && (null == t ? void 0 : t.closest(this.settings.classNames.tagSelector))
        }
        ...
        function O(t, e, i) {
            return t ? (e && (t.__tagifyTagData = i ? e : h({}, t.__tagifyTagData || {}, e)), t.__tagifyTagData) : (a.warn("tag element doesn't exist", {
                tagElm: t,
                data: e
            }), e)
        }
        ...
        function D(t, e) {
            t.forEach((function(t) {
                if (O(t.previousSibling) || !t.previousSibling) {
        ...
        var C, k, L = (C = function(t) {
                    ...
                    callbacks: {
                        onKeyDown: function(t) {
                            ...
                            if (this.state.hasFocus && !this.state.composing) {
                                var i = this.settings,
                                    n = this.DOM.dropdown.querySelector(i.classNames.dropdownItemActiveSelector),
                                ...
                                i.hooks.beforeKeyDown(t, {
                                    ...
                                    switch (t.key) {
                                        ...
                                        case "Up":
                                            ...
                                            n && (n = e.dropdown.getNextOrPrevOption(n, !c)), n && n.matches(i.classNames.dropdownItemSelector) || (n = d[c ? d.length - 1 : 0]), e.dropdown.highlightOption(n, !0);
                                            break;
                                        case "PageUp":
                                        case "PageDown":
                                            var u;
                                            t.preventDefault();
                                            var g = e.dropdown.getAllSuggestionsRefs(),
                                                h = Math.floor(e.DOM.dropdown.content.clientHeight / (null === (u = g[0]) || void 0 === u ? void 0 : u.offsetHeight)) || 1,
                                                p = "PageUp" === t.key;
                                            if (n) {
                                                var f = g.indexOf(n),
                                                    m = p ? Math.max(0, f - h) : Math.min(g.length - 1, f + h);
                                                n = g[m]
                                            } else n = g[0];
                                            e.dropdown.highlightOption(n, !0);
                                            break;
                                        case "Home":
                                        case "End":
                                            t.preventDefault();
                                            var v = e.dropdown.getAllSuggestionsRefs();
                                            n = v["Home" === t.key ? 0 : v.length - 1], e.dropdown.highlightOption(n, !0);
                                            break;
                                        case "Escape":
                                        case "Esc":
                                            e.dropdown.hide();
                                        ...
                                        case "Tab":
                                            var b = !i.autoComplete.rightKey || !i.autoComplete.tabKey;
                                            if (!o && !r && n && b && !e.state.editing && s) {
                                                t.preventDefault();
                                                var y = e.dropdown.getMappedValue(s);
                                                return e.state.autoCompleteData = s, e.input.autocomplete.set.call(e, y), !1
                                            }
                                            return !0;
                                        case "Enter":
                                            t.preventDefault(), e.state.actions.selectOption = !0, setTimeout((function() {
                                                ...
                                                if (n) return e.dropdown.selectOption(n), n = e.dropdown.getNextOrPrevOption(n, !c), void e.dropdown.highlightOption(n);
                                        ...
                                        case "Backspace":
                                            ...
                                            var w = e.input.raw.call(e);
                                            "" != w && 8203 != w.charCodeAt(0) || (!0 === i.backspace ? e.removeTags() : "edit" == i.backspace && setTimeout(e.editTag.bind(e), 0))
                                    }
                                }))
                            }
                        },
                ...
                getSuggestionDataByNode: function(t) {
                    for (var e, i = t && t.getAttribute("value"), n = this.suggestedListItems.length; n--;) {
                        if (g(e = this.suggestedListItems[n]) && e.value == i) return e;
                        if (e == i) return {
                            value: e
                        }
                    }
                ...
                selectOption: function(t, e) {
                    ...
                    if (this.trigger("dropdown:select", {
                        ...
                        if (this.state.editing) {
                            ...
                            c = n.transformTag.call(this, u) || u, this.onEditTagDone(null, h({
                                __isValid: !0
                            }, c))
                ...
                filterListItems: function(t, e) {
                    var i, n, s, a, o, r, l = function() {
                            ...
                            u.fuzzySearch && !e.exact ? (a = b.reduce((function(t, e) {
                                return t + " " + (n[e] || "")
                            }), "").toLowerCase().trim(), u.accentedSearch && (a = f(a), r = f(r)), d = 0 == a.indexOf(r), c = a === r, v = a, s = r.toLowerCase().split(" ").every((function(t) {
                                return v.includes(t.toLowerCase())
                            }))) : (d = !0, s = b.some((function(t) {
                                var i = "" + (n[t] || "");
                                return u.accentedSearch && (i = f(i), r = f(r)), u.caseSensitive || (i = i.toLowerCase()), c = i === r, e.exact ? i === r : 0 == i.indexOf(r)
                            }))), o = !u.includeSelectedTags && i.isTagDuplicate(g(n) ? n.value : n), s && !o && (c && d ? p.push(n) : "startsWith" == u.sortby && d ? h.unshift(n) : h.push(n))
                        },
                        d = this,
                        c = this.settings,
                        u = c.dropdown,
                        ...
                        p = [],
                        m = c.whitelist,
                        v = u.maxItems >= 0 ? u.maxItems : 1 / 0,
                        b = u.includeSelectedTags || "select" == c.mode,
                        y = "function" == typeof u.sortby,
                        w = u.searchKeys,
                        T = 0;
                    if (!(t = "select" == c.mode && this.value.length && this.value[0][c.tagTextProp] == t ? "" : t) || !w.length) {
                        h = b ? m : m.filter((function(t) {
                            return !d.isTagDuplicate(g(t) ? t.value : t)
                        }));
                        var O = y ? u.sortby(h, r) : h.slice(0, v);
                        return this.state.dropdown.suggestions = O, O
                    }
                    for (r = u.caseSensitive ? "" + t : ("" + t).toLowerCase(); T < m.length; T++) i = this, l();
                    return this.state.dropdown.suggestions = p.concat(h), O = y ? u.sortby(p.concat(h), r) : p.concat(h).slice(0, v), this.state.dropdown.suggestions = O, O
                },
                ...
                createListHTML: function(t) {
                    var e = this;
                    return h([], t).map((function(t, i) {
                        "string" != typeof t && "number" != typeof t || (t = {
                            value: t
                        });
                        var n = e.dropdown.getMappedValue(t);
                        return n = "string" == typeof n && e.settings.dropdown.escapeHTML ? u(n) : n, e.settings.templates.dropdownItem.apply(e, [E(M({}, t), {
                            mappedValue: n
                        }), e])
                    })).join("")
                }
                ...
                show: function(t) {
                    var e, i, n, s = this,
                        a = this.settings,
                        r = "mix" == a.mode && !a.enforceWhitelist,
                        l = !a.whitelist || !a.whitelist.length,
                        d = "manual" == a.dropdown.position;
                    if (t = void 0 === t ? this.state.inputText : t, !(l && !r && !a.templates.dropdownItemNoMatch || !1 === a.dropdown.enabled || this.state.isLoading || this.settings.readonly)) {
                        if (clearTimeout(this.dropdownHide__bindEventsTimeout), this.suggestedListItems = this.dropdown.filterListItems(t), t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t), a.templates.dropdownItemNoMatch && (n = a.templates.dropdownItemNoMatch.call(this, {
                                value: t
                            }))), !n) {
                            if (this.suggestedListItems.length) t && r && !this.state.editing.scope && !o(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({
                                value: t
                            });
                            else {
                            ...
                            i = "" + (g(e = this.suggestedListItems[0]) ? e.value : e), a.autoComplete && i && 0 == i.indexOf(t) && this.input.autocomplete.suggest.call(this, e)
                        }
                        this.dropdown.fill(n), a.dropdown.highlightFirst && this.dropdown.highlightOption(this.DOM.dropdown.content.querySelector(a.classNames.dropdownItemSelector)), this.state.dropdown.visible || setTimeout(this.dropdown.events.binding.bind(this)), this.state.dropdown.visible = t || !0, this.state.dropdown.query = t, this.setStateSelection(), d || setTimeout((function() {
                ...
                render: function() {
                    var t, e, i = this,
                        n = ((e = this.DOM.dropdown.cloneNode(!0)).style.cssText = "position:fixed; top:-9999px; opacity:0", document.body.appendChild(e), t = e.clientHeight, e.parentNode.removeChild(e), t),
                        s = this.settings,
                        a = this.dropdown.getAppendTarget();
                    return !1 === s.dropdown.enabled || (this.DOM.scope.setAttribute("aria-expanded", !0), document.body.contains(this.DOM.dropdown) || (this.DOM.dropdown.classList.add(s.classNames.dropdownInital), this.dropdown.position(n), a.appendChild(this.DOM.dropdown), setTimeout((function() {
                        return i.DOM.dropdown.classList.remove(s.classNames.dropdownInital)
                    })))), this
                },
                fill: function(t) {
                ...
                position: function(t) {
                    ...
                    if ("manual" != e.position && i) {
                        var n, s, a, o, r, l, d, c, u, g = this.DOM.dropdown,
                            h = e.RTL,
                            p = i === document.body,
                            f = i === this.DOM.scope,
                        ...
                        if (t = t || g.clientHeight, this.state.dropdown.visible) {
                            ...
                            var O;
                            s = Math.floor(s), a = Math.ceil(a), c = ((d = null !== (O = e.placeAbove) && void 0 !== O ? O : b - n.bottom < t) ? s : a) + m, u = "left: ".concat(o + (h && n.width || 0) + window.pageXOffset, "px;"), g.style.cssText = "".concat(u, "; top: ").concat(c, "px; min-width: ").concat(r, "; max-width: ").concat(r), g.setAttribute("placement", d ? "top" : "bottom"), g.setAttribute("position", y)
                        }
                    }
                }
            }) ? k : {}, Object.getOwnPropertyDescriptors ? Object.defineProperties(C, Object.getOwnPropertyDescriptors(k)) : function(t) {
                var e = Object.keys(t);
                if (Object.getOwnPropertySymbols) {
                    var i = Object.getOwnPropertySymbols(t);
                    e.push.apply(e, i)
            ...
            V = {
                ...
                input: function() {
                    var t = this.settings,
                        e = t.placeholder || i;
                    return "<span ".concat(!t.readonly && t.userInput ? "contenteditable" : "", ' tabIndex="0" data-placeholder="').concat(e, '" aria-placeholder="').concat(t.placeholder || "", '"\n                    class="').concat(t.classNames.input, '"\n                    role="textbox"\n                    autocapitalize="false"\n                    autocorrect="off"\n                    aria-autocomplete="both"\n                    aria-multiline="').concat("mix" == t.mode, '"></span>')
                },
                tag: function(t, e) {
                    var i = e.settings;
        ...
        function U(t) {
            return function(t) {
                ...
                if (t) {
                    ...
                    var i = Object.prototype.toString.call(t).slice(8, -1);
                    return "Object" === i && t.constructor && (i = t.constructor.name), "Map" === i || "Set" === i ? Array.from(i) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? H(t, e) : void 0
                }
            }(t) || function() {
                throw new TypeError("Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
            }()
            ...
            callbacks: {
                onFocusBlur: function(t) {
                    var e, i, n = this.settings,
                        s = y.call(this, t.relatedTarget),
                        a = b.call(this, t.relatedTarget),
                    ...
                    if (!(h || p || o))
                        if (this.state.hasFocus = !(!r && !s) && +new Date, this.toggleFocusClass(this.state.hasFocus), "mix" != n.mode) {
                            if (r) {
                                if (!n.focusable) return;
                                var f = 0 === n.dropdown.enabled && !this.state.dropdown.visible,
                                    m = !a || "select" === n.mode;
                                return this.trigger("focus", g), void(f && m && this.dropdown.show(this.value.length ? "" : void 0))
                            }
                            if (l) {
                                if (this.trigger("blur", g), this.loading(!1), "select" == n.mode) {
                                    if (this.value.length) {
                                        var v = this.getTagElms()[0];
                                        d = this.trim(v.textContent)
                                    }
                                    c === d && (d = "")
                                }
                ...
                onWindowKeyDown: function(t) {
                    var e, i = this.settings,
                        ...
                        s = y.call(this, n) && this.DOM.scope.contains(n),
                        a = n === this.DOM.input,
                        o = s && n.hasAttribute("readonly");
                    if ((this.state.hasFocus || s && !o) && !a) {
                        e = n.nextElementSibling;
                        var r = t.target.classList.contains(i.classNames.tagX);
                        switch (t.key) {
                            case "Backspace":
                                i.readonly || this.state.editing || (this.removeTags(n), (e || this.DOM.input).focus());
                                break;
                            case "Enter":
                                if (r) return void this.removeTags(t.target.parentNode);
                                i.a11y.focusableTags && b.call(this, n) && setTimeout(this.editTag.bind(this), 0, n);
                                break;
                            case "ArrowDown":
                                ...
                                switch (t.key) {
                                    ...
                                    case "Backspace":
                                        ...
                                        var a = document.getSelection(),
                                            ...
                                            l = 1 == a.anchorNode.nodeType || !a.anchorOffset && r && 1 == r.nodeType && a.anchorNode.previousSibling;
                                        ! function(t) {
                                        ...
                                        var d, u, g, h = e.getTagElms(),
                                            p = 1 === a.anchorNode.length && a.anchorNode.nodeValue == String.fromCharCode(8203);
                                        if ("edit" == i.backspace && l) return d = 1 == a.anchorNode.nodeType ? null : a.anchorNode.previousElementSibling, setTimeout(e.editTag.bind(e), 0, d), void t.preventDefault();
                                        if (m() && W(l, Element)) return g = c(l), l.hasAttribute("readonly") || l.remove(), e.DOM.input.focus(), void setTimeout((function() {
                                            x(g), e.DOM.input.click()
                                        }));
                                        if ("BR" == a.anchorNode.nodeName) return;
                                        if ((o || l) && 1 == a.anchorNode.nodeType ? u = 0 == a.anchorOffset ? o ? h[0] : null : h[Math.min(h.length, a.anchorOffset) - 1] : o ? u = a.anchorNode.nextElementSibling : W(l, Element) && (u = l), 3 == a.anchorNode.nodeType && !a.anchorNode.nodeValue && a.anchorNode.previousElementSibling && t.preventDefault(), (l || o) && !i.backspace) return void t.preventDefault();
                                        if ("Range" != a.type && !a.anchorOffset && a.anchorNode == e.DOM.input && "Delete" != t.key) return void t.preventDefault();
                                        if ("Range" != a.type && u && u.hasAttribute("readonly")) return void x(c(u));
                                        "Delete" == t.key && p && O(a.anchorNode.nextSibling) && e.removeTags(a.anchorNode.nextSibling)
                                }
                                return !0
                            }
                            var f = "manual" == i.dropdown.position;
                            switch (t.key) {
                                case "Backspace":
                                ...
                                case "Tab":
                                    return !0;
                                case "Enter":
                                    if (e.state.dropdown.visible && !f) return;
                                    t.preventDefault();
                                    var b = e.state.autoCompleteData || n;
                                    setTimeout((function() {
                                        e.state.dropdown.visible && !f || e.state.actions.selectOption || !i.addTagOn.includes(t.key.toLowerCase()) || (e.addTags([b], !0), e.state.autoCompleteData = null)
                                    }))
                            }
                        })).catch((function(t) {
                            return t
                ...
                onMixTagsInput: function(t) {
                    var e, i, n, s, a, o, r, l, d = this,
                        c = this.settings,
                        u = this.value.length,
                        g = this.getTagElms(),
                        p = document.createDocumentFragment(),
                        f = window.getSelection().getRangeAt(0),
                        v = [].map.call(g, (function(t) {
                            return O(t).value
                        }));
                    if ("deleteContentBackward" == t.inputType && m() && this.events.callbacks.onKeydown.call(this, {
                            target: t.target,
                            key: "Backspace"
                        }), D(this.getTagElms()), this.value.slice().forEach((function(t) {
                            t.readonly && !v.includes(t.value) && p.appendChild(d.createTagElem(t))
                        })), p.childNodes.length && (f.insertNode(p), this.setRangeAtStartEnd(!1, p.lastChild)), g.length != u) return this.value = [].map.call(this.getTagElms(), (function(t) {
                        return O(t)
                    })), void this.update({
                    ...
                    if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                        if ((f = o.getRangeAt(0).cloneRange()).collapse(!0), f.setStart(o.focusNode, 0), n = (e = f.toString().slice(0, f.endOffset)).split(c.pattern).length - 1, (i = e.match(c.pattern)) && (s = e.slice(e.lastIndexOf(i[i.length - 1]))), s) {
                            ...
                            } catch (t) {}(r || n < this.state.mixMode.matchedPatternCount) && (a = !1)
                ...
                onEditTagInput: function(t, e) {
                    var i, n = t.closest("." + this.settings.classNames.tag),
                        s = this.getNodeIndex(n),
                        a = O(n),
                        o = this.input.normalize.call(this, t),
                        r = (B(i = {}, this.settings.tagTextProp, o), B(i, "__tagId", a.__tagId), i),
                        l = this.validateTag(r);
                    this.editTagChangeDetected(h(a, r)) || !0 !== t.originalIsValid || (l = !0), n.classList.toggle(this.settings.classNames.tagInvalid, !0 !== l), a.__isValid = l, n.title = !0 === l ? a.title || a.value : l, o.length >= this.settings.dropdown.enabled && (this.state.editing && (this.state.editing.value = o), this.dropdown.show(o)), this.trigger("edit:input", {
                        tag: n,
                        index: s,
                        data: h({}, this.value[s], {
                            newValue: o
                ...
                onEditTagBlur: function(t, e) {
                    var i = b.call(this, e.relatedTarget);
                    if ("select" == this.settings.mode && i && e.relatedTarget.contains(e.target)) this.dropdown.hide();
                    else if (this.state.editing && (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(document.activeElement) || this.trigger("blur", {}), this.DOM.scope.contains(t))) {
                        var n, s, a, o = this.settings,
                            r = t.closest("." + o.classNames.tag),
                            l = O(r),
                            d = this.input.normalize.call(this, t),
                            c = (B(n = {}, o.tagTextProp, d), B(n, "__tagId", l.__tagId), n),
                            u = l.__originalData,
                            g = this.editTagChangeDetected(h(l, c)),
                            p = this.validateTag(c);
                        if (d)
                            if (g) {
                                var f;
                                if (s = this.hasMaxTags(), a = h({}, u, (B(f = {}, o.tagTextProp, this.trim(d)), B(f, "__isValid", p), f)), o.transformTag.call(this, a, u), !0 !== (p = (!s || !0 === u.__isValid) && this.validateTag(a))) {
                ...
                onDoubleClickScope: function(t) {
                    var e, i, n = t.target.closest("." + this.settings.classNames.tag),
                        s = O(n),
                        a = this.settings;
                        ...
                        t.addedNodes.forEach((function(t) {
                            if ("<div><br></div>" == t.outerHTML) t.replaceWith(document.createElement("br"));
                                ...
                                if (3 != (null === (s = t.previousSibling) || void 0 === s ? void 0 : s.nodeType) || t.previousSibling.textContent || t.previousSibling.remove(), t.previousSibling && "BR" == t.previousSibling.nodeName) {
                                    ...
                                    o.trim() && x(t.previousSibling)
                                } else t.previousSibling && !O(t.previousSibling) || t.before("​")
                            }
                        })), t.removedNodes.forEach((function(t) {
                            t && "BR" == t.nodeName && b.call(e, i) && (e.removeTags(i), e.fixFirefoxLastTagNoCaret())
                        }))
                    }));
        ...
        function G(t) {
            return function(t) {
                ...
                if (t) {
                    ...
                    var i = Object.prototype.toString.call(t).slice(8, -1);
                    return "Object" === i && t.constructor && (i = t.constructor.name), "Map" === i || "Set" === i ? Array.from(i) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? q(t, e) : void 0
                }
            }(t) || function() {
                throw new TypeError("Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
            }()
        ...
        function $(t, e) {
            if (!t) {
                a.warn("input element not found", t);
            ...
            if (t.__tagify) return a.warn("input element is already Tagified - Same instance is returned.", t), t.__tagify;
            var n;
            h(this, function(t) {
                ...
                return {
                            ...
                            var e = function(t, e) {
                                    return function(t) {
                                        ...
                                        if (t) {
                                            ...
                                            var i = Object.prototype.toString.call(t).slice(8, -1);
                                            return "Object" === i && t.constructor && (i = t.constructor.name), "Map" === i || "Set" === i ? Array.from(i) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? R(t, e) : void 0
                                        }
                                    }(t, e) || function() {
                    ...
                    off: function(t, e) {
                        return t && (e ? n("remove", t, e) : t.split(/\s+/g).forEach((function(t) {
                            var e;
                    ...
                    trigger: function(i, n, s) {
                        var o;
                        if (s = s || {
                                cloneData: !0
                            }, i)
                            if (t.settings.isJQueryPlugin) "remove" == i && (i = "removeTag"), jQuery(t.DOM.originalInput).triggerHandler(i, [n]);
                            else {
                                try {
                                    var r = "object" == typeof n ? n : {
                                        value: n
                                    };
                                    if ((r = s.cloneData ? h({}, r) : r).tagify = this, n.event && (r.event = this.cloneEvent(n.event)), F(n, Object))
                                        for (var l in n) F(n[l], HTMLElement) && (r[l] = n[l]);
                                    o = new CustomEvent(i, {
                                        detail: r
                                    })
                                } catch (t) {
            ...
            }(this)), this.isFirefox = /firefox|fxios/i.test(navigator.userAgent) && !/seamonkey/i.test(navigator.userAgent), this.isIE = window.document.documentMode, e = e || {}, this.getPersistedData = (n = e.id, function(t) {
                var e;
                if (n) {
                    var i, s = "/" + t;
                    if (1 === (null === (e = localStorage) || void 0 === e ? void 0 : e.getItem(j + n + "/v"))) try {
                        i = JSON.parse(localStorage[j + n + s])
                    } catch (t) {}
                    return i
                }
            }), this.setPersistedData = function(t) {
                var e;
                return t ? (null === (e = localStorage) || void 0 === e || e.setItem(j + t + "/v", 1), function(e, i) {
                    var n, s = "/" + i,
                        a = JSON.stringify(e);
                    e && i && (null === (n = localStorage) || void 0 === n || n.setItem(j + t + s, a), dispatchEvent(new Event("storage")))
                }) : function() {}
                ...
                return function(e) {
                    ...
                    if (e) localStorage.removeItem(i + e);
                        ...
                        for (var n in localStorage) n.includes(i) && localStorage.removeItem(n)
                }
        ...
        $.prototype = {
            ...
            parseTemplate: function(t, e) {
                return d((t = this.settings.templates[t] || t).apply(this, e))
            },
            set whitelist(t) {
            ...
            applySettings: function(t, e) {
                var i, n;
                S.templates = this.templates;
                var s = h({}, S, "mix" == e.mode ? {
                        dropdown: {
                            position: "text"
                        }
                    } : {}),
                    a = this.settings = h({}, s, e);
                if (a.disabled = t.hasAttribute("disabled"), a.readonly = a.readonly || t.hasAttribute("readonly"), a.placeholder = u(t.getAttribute("placeholder") || a.placeholder || ""), a.required = t.hasAttribute("required"), this.generateClassSelectors(a.classNames), void 0 === a.dropdown.includeSelectedTags && (a.dropdown.includeSelectedTags = a.duplicates), this.isIE && (a.autoComplete = !1), ["whitelist", "blacklist"].forEach((function(e) {
                        var i = t.getAttribute("data-" + e);
                        i && X(i = i.split(a.delimiters), Array) && (a[e] = i)
                    })), "autoComplete" in e && !g(e.autoComplete) && (a.autoComplete = S.autoComplete, a.autoComplete.enabled = e.autoComplete), "mix" == a.mode && (a.pattern = a.pattern || /@/, a.autoComplete.rightKey = !0, a.delimiters = e.delimiters || null, a.tagTextProp && !a.dropdown.searchKeys.includes(a.tagTextProp) && a.dropdown.searchKeys.push(a.tagTextProp)), t.pattern) try {
                ...
                a.disabled && (a.userInput = !1), this.TEXTS = J({}, P, a.texts || {}), ("select" != a.mode || (null === (i = e.dropdown) || void 0 === i ? void 0 : i.enabled)) && a.userInput || (a.dropdown.enabled = 0), a.dropdown.appendTarget = (null === (n = e.dropdown) || void 0 === n ? void 0 : n.appendTarget) || document.body;
                var o = this.getPersistedData("whitelist");
                Array.isArray(o) && (this.whitelist = Array.isArray(a.whitelist) ? p(a.whitelist, o) : o)
            },
            ...
            getCustomAttributes: function(t) {
                if (!g(t)) return "";
                var e, i = {};
                for (e in t) "__" != e.slice(0, 2) && "class" != e && t.hasOwnProperty(e) && void 0 !== t[e] && (i[e] = u(t[e]));
                return i
            },
            ...
            getCSSVars: function() {
                var t, e, i = getComputedStyle(this.DOM.scope, null);
                this.CSSVars = {
                    ...
                    }(i.getPropertyValue("--tag-hide-transition")), e = t.value, "s" == t.unit ? 1e3 * e : e)
                }
            },
            build: function(t) {
                var e = this.DOM,
            ...
            setTagTextNode: function(t, e) {
                this.getTagTextNode(t).innerHTML = u(e)
            },
            editTag: function(t, e) {
                ...
                if (!c && this.dropdown.hide(), s) {
                    if (!X(r, Object) || !("editable" in r) || r.editable) return r = O(t, {
                        __originalData: h({}, r),
                        __originalHTML: t.cloneNode(!0)
                    }), O(r.__originalHTML, r.__originalData), s.setAttribute("contenteditable", !0), t.classList.add(n.classNames.tagEditing), this.events.callbacks.onEditTagFocus.call(this, t), s.addEventListener("click", l.onEditTagClick.bind(this, t)), s.addEventListener("blur", l.onEditTagBlur.bind(this, this.getTagTextNode(t))), s.addEventListener("input", l.onEditTagInput.bind(this, s)), s.addEventListener("paste", l.onEditTagPaste.bind(this, s)), s.addEventListener("keydown", (function(e) {
                        return l.onEditTagkeydown.call(i, e, t)
                    })), s.addEventListener("compositionstart", l.onCompositionStart.bind(this)), s.addEventListener("compositionend", l.onCompositionEnd.bind(this)), e.skipValidation || (d = this.editTagToggleValidity(t)), s.originalIsValid = d, this.trigger("edit:start", {
                        tag: t,
                        index: o,
                        data: r,
                        isValid: d
                    }), s.focus(), !c && this.setRangeAtStartEnd(!1, s), 0 === n.dropdown.enabled && !c && this.dropdown.show(), this.state.hasFocus = !0, this
                } else a.warn("Cannot find element in Tag template: .", n.classNames.tagTextSelector)
            },
            editTagToggleValidity: function(t, e) {
                var i;
                if (e = e || O(t)) return (i = !("__isValid" in e) || !0 === e.__isValid) || this.removeTagsFromValue(t), this.update(), t.classList.toggle(this.settings.classNames.tagNotAllowed, !i), e.__isValid = i, e.__isValid;
                a.warn("tag has no data: ", t, e)
            },
            ...
            input: {
                set: function() {
                    ...
                    this.state.inputText = t, e && (this.DOM.input.innerHTML = u("" + t), t && this.toggleClass(i.classNames.empty, !this.DOM.input.innerHTML)), !t && n && this.dropdown.hide.bind(this), this.input.autocomplete.suggest.call(this), this.input.validate.call(this)
                },
                raw: function() {
            ...
            isTagDuplicate: function(t, e, i) {
                ...
                try {
                    for (var l, d = this.value[Symbol.iterator](); !(s = (l = d.next()).done); s = !0) {
                        var c = l.value;
                        o(this.trim("" + t), c.value, e) && i != c.__tagId && n++
                    }
                } catch (t) {
                    a = !0, r = t
                } finally {
            ...
            getTagIndexByValue: function(t) {
                ...
                return this.getTagElms().forEach((function(s, a) {
                    s.__tagifyTagData && o(e.trim(s.__tagifyTagData.value), t, n) && i.push(a)
                })), i
            },
            ...
            getWhitelistItem: function(t, e, i) {
                ...
                return (i = i || s.whitelist).some((function(i) {
                    var a = "object" == typeof i ? i[e] || i.value : i;
                    if (o(a, t, s.dropdown.caseSensitive, s.trim)) return n = "object" == typeof i ? i : {
                        value: i
                    }, !0
                })), n || "value" != e || "value" == s.tagTextProp || (n = this.getWhitelistItem(t, s.tagTextProp, i)), n
            },
            ...
            parseMixTags: function(t) {
                ...
                return c.forEach((function(t, e) {
                    ...
                    withoutChangeEvent: !0
                }), D(c, this.state.hasFocus), t
            },
            replaceTextWithNode: function(t, e) {
                if (this.state.tag || e) {
                    e = e || this.state.tag.prefix + this.state.tag.value;
                    var i, n, s = this.state.selection || window.getSelection(),
                        a = s.anchorNode,
                        o = this.state.tag.delimiters ? this.state.tag.delimiters.length : 0;
                    return a.splitText(s.anchorOffset - o), -1 == (i = a.nodeValue.lastIndexOf(e)) || (n = a.splitText(i), t && a.parentNode.replaceChild(t, n)), !0
                }
            },
            prepareNewTagNode: function(t, e) {
                ...
                if (t = Object.assign({}, a), i.transformTag.call(this, t), t.__isValid = this.hasMaxTags() || this.validateTag(t), !0 !== t.__isValid) {
                    ...
                    if (h(s, this.getInvalidTagAttrs(t, t.__isValid), {
                            __preInvalidData: a
            ...
            addEmptyTag: function(t) {
                ...
                O(i, e), this.appendTag(i), this.editTag(i, {
                    skipValidation: !0
            ...
            createTagElem: function(t, e) {
                ...
                }(i = this.parseTemplate("tag", [n, this])), O(i, t), i
            },
            ...
            getCleanValue: function(t) {
                return r(t || this.value, this.dataProps)
            },
